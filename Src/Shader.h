...
public:
	...
	// Fbxモデル　スタティツクメッシュ用のシェーダー
// （トゥーンシェーディング）
	ID3D11VertexShader* m_pFbxStaticMeshToon_VS;
	ID3D11PixelShader* m_pFbxStaticMeshToon_PS;

	// Fbxモデル　スキンメッシュ用のシェーダー
	// （トゥーンシェーディング）
	ID3D11VertexShader* m_pFbxSkinMeshToon_VS;
	ID3D11PixelShader* m_pFbxSkinMeshToon_PS;
